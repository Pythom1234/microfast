...
namespace sensors {
bool buttonA() {
  return !pins::getDigital(Pin::BUTTON_A);
}
bool buttonB() {
  return !pins::getDigital(Pin::BUTTON_B);
}
i16 microphone() {
  volatile i16 value = 0;
  if (!Peripheral::SAADC->ENABLE ||
...
void drawImage(string img) {
  u32 image;
  if (img == "1")
    image = 0b00010'00100'00100'00000'00000;
  if (img == "2")
    image = 0b00010'00010'00100'00000'00000;
  if (img == "3")
    image = 0b00001'00010'00100'00000'00000;
  if (img == "4")
    image = 0b00000'00011'00100'00000'00000;
  if (img == "5")
    image = 0b00000'00001'00110'00000'00000;
  if (img == "6")
    image = 0b00000'00000'00111'00000'00000;
  if (img == "7")
    image = 0b00000'00000'00110'00001'00000;
  if (img == "8")
    image = 0b00000'00000'00100'00011'00000;
  if (img == "9")
    image = 0b00000'00000'00100'00010'00001;
  if (img == "10")
    image = 0b00000'00000'00100'00010'00010;
  if (img == "11")
    image = 0b00000'00000'00100'00100'00010;
  if (img == "12")
    image = 0b00000'00000'00100'00100'00100;
  if (img == "13")
    image = 0b00000'00000'00100'00100'01000;
  if (img == "14")
    image = 0b00000'00000'00100'01000'01000;
  if (img == "15")
    image = 0b00000'00000'00100'01000'10000;
  if (img == "16")
    image = 0b00000'00000'00100'11000'00000;
  if (img == "17")
    image = 0b00000'00000'01100'10000'00000;
  if (img == "18")
    image = 0b00000'00000'11100'00000'00000;
  if (img == "19")
    image = 0b00000'10000'01100'00000'00000;
  if (img == "20")
    image = 0b00000'11000'00100'00000'00000;
  if (img == "21")
    image = 0b10000'01000'00100'00000'00000;
  if (img == "22")
    image = 0b01000'01000'00100'00000'00000;
  if (img == "23")
    image = 0b01000'00100'00100'00000'00000;
  if (img == "24" || img == "0")
    image = 0b00100'00100'00100'00000'00000;
  if (img == "happy")
    image = 0b00000'01010'00000'10001'01110;
  if (img == "sad")
    image = 0b00000'01010'00000'01110'10001;
  if (img == "heart")
    image = 0b01010'11111'11111'01110'00100;
  if (img == "small heart")
    image = 0b00000'01010'01110'00100'00000;
  if (img == "yes")
    image = 0b00000'00001'00010'10100'01000;
  if (img == "no")
    image = 0b10001'01010'00100'01010'10001;
  if (img == "confused")
    image = 0b00000'01010'00000'01010'10101;
  if (img == "asleep")
    image = 0b00000'11011'00000'01110'00000;
  if (img == "square")
    image = 0b11111'10001'10001'10001'11111;
  if (img == "small square")
    image = 0b00000'01110'01010'01110'00000;
  drawImage(image);
}
} // namespace display
